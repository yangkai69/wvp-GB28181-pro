...
public class DeviceQuery {
    ...
    @GetMapping("/devices/setlocation")
    public String setlocation(@RequestParam String channelId) {

        DeviceChannel deviceChannel = new DeviceChannel();
        deviceChannel.setChannelId(channelId);
        deviceChannel.setLatitude(111);
        deviceChannel.setLongitude(222);
        storager.addChannelId(deviceChannel);
    ...
    public String channels(@RequestParam String channels) {
        ...
        List<DeviceChannel> list = storager.queryChannel(channels);
    ...
    public JSONObject getNum() {
        ...
        jsonObject.put("result", myJsonObject);
